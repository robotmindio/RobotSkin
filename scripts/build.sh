...
build hex_panel_side_40 05_hex_panels -D 'SIDE=40'
...
build flat_gasket_80 02_connectors -D 'PART="flat_gasket"' -D 'LENGTH=80'
build angle_gasket_80 02_connectors -D 'PART="angle_gasket"' -D 'LENGTH=80'
