...
provides a 30×30×34 mm hub. Its raised 4 mm top cap has a complete 3×3 female
port grid, while each vertical face has a centred vertical line of three. The
cap keeps those full perpendicular sockets separate. The four lower peg screw
paths continue to matching top-corner ports. Lock the hub using four M3×40
pan-head screws from above into heat-set inserts in the drive plate; the pegs
locate the joint and the screws carry it.
