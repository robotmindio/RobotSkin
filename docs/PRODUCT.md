...
| RM-SV-H25C-C | `h25t_port_cube_3x3.stl` | C | STS3215 drive plate to 40 mm five-face 3×3 RobotSkin end-effector hub |
...
| HW-SCR-M3X45-PH | M3×45 pan-head machine screw | H25T end-effector hub lock | 4 |
...
| H25T end-effector hub | H25T drive plate | Five 3×3 V0.1 female port faces | 40 mm body leaves every port complete; four M3×45 locks enter from the top corners |
