...
| RM-PC-ES3DC-C | `esp32_s3_devkitc_carrier.stl` | C | One-piece inverted ESP32-S3-DevKitC-1 carrier |
...
| ESP32-S3-DevKitC-1 carrier | V0.1 ports | Official ESP32-S3-DevKitC-1, 62.74×25.40 mm PCB and 2×22 pins | Six continuous lock stations; plastic-header snap fit; installs component-side down; clone fit must be checked |
