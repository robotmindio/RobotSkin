...
| RM-LD-PJ03-A | `ld06_pj030_clip_carrier.stl` | A | 40 mm-long clip carrier for LD06 PJ030 controller |
...
| LD06 PJ030 clip carrier | V0.1 ports | 40×20×1.6 mm PJ030 controller without mounting holes | Four side lips retain the PCB by pressure; install with the connector ends exposed; geometry verified, physical retention pending |
