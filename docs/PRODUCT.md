...
| RM-SV-H25C-B | `h25t_port_cube_3x3.stl` | B | STS3215 drive plate to five-face 3×3 RobotSkin end-effector hub |
...
| H25T end-effector hub | H25T drive plate | Five 3×3 V0.1 female port faces | Four M3×35 structural locks enter from the top corners |
